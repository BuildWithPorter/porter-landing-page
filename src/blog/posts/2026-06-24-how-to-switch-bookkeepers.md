---
title: "How to switch bookkeepers (the playbook nobody gives you)"
slug: "how-to-switch-bookkeepers"
date: "2026-06-24"
description: "How do you switch bookkeepers without losing data or getting burned twice? Most small-business owners do it reactively, in a panic. This is the playbook for doing it on purpose: when to switch, what to ask the next firm, and the structural fixes that keep you from getting burned twice."
pillar: "bookkeeping"
tags: ["how to switch bookkeepers", "how to change bookkeepers", "when to fire your bookkeeper", "bookkeeper red flags", "how to vet a bookkeeping firm", "questions to ask a bookkeeper", "small business bookkeeper checklist", "switching from Bench Accounting", "post-Bench bookkeeping", "how to find a new bookkeeper"]
faqs: [{"q":"When should I switch bookkeepers?","a":"Switch when any of these are true: month-end closes are late or missed, unexplained variances never get resolved, invoices go out with errors, communication is slow or scattered across channels, or you feel you do not understand your own numbers. Waiting for a bigger problem is the reactive move that most small-business owners regret."},{"q":"What are the biggest red flags in a bookkeeping firm?","a":"Slow response times, no clear point of contact, generic monthly reports that do not reflect how your business actually works, refusal to answer specific questions about journal entries, no visible reconciliation process, and pricing that is entirely time-based with no fixed monthly component. Any two of these together is enough reason to start evaluating alternatives."},{"q":"How do I switch bookkeepers without losing my data?","a":"Before you terminate, request a complete export: your QuickBooks or Xero backup file, the general ledger, journal entry history, and reconciliation reports for at least the last 12 months. Confirm you have admin access on every accounting and bank connection. Only after you have verified the export is complete should you notify the outgoing firm."},{"q":"What questions should I ask a new bookkeeping firm before signing?","a":"How do you handle month-end close and what is your typical turnaround? What is your response time SLA for questions? Can I speak to a current customer in my industry? How do you handle exception transactions or ambiguous entries? Do you offer a fixed monthly price? What is your data-export process if I ever want to leave? A firm that cannot answer these clearly is not the right next firm."}]
heroImage: "/blog/how-to-switch-bookkeepers-hero.jpg"
thumbnail: "/blog/how-to-switch-bookkeepers-thumb.jpg"
---
...
<div>
<p class="ql-q">How many bookkeepers will work on my books in the next 24 months?</p>
<p class="ql-a">The single most-repeated complaint about outsourced firms is turnover. Each handoff means a new person re-learning your business and probably making the same categorization mistakes the last one finally figured out. A firm that cannot promise continuity is promising you errors. Ask for a number, and ask what happens if the person leaves.</p>
</div>
</li>
<li class="ql-item">
<div class="ql-num">02</div>
<div>
<p class="ql-q">What is your response-time SLA, and is it in writing?</p>
<p class="ql-a">"We try to respond within a few business days" is not an SLA. That is a hope. Ask for a number. Ask what happens if they miss it. A firm with a real SLA will have an answer ready; one that has never measured response time will improvise.</p>
</div>
</li>
<li class="ql-item">
<div class="ql-num">03</div>
<div>
<p class="ql-q">How long does it take you to close the month, and what does that include?</p>
<p class="ql-a">A real close means a reconciled set of books, a P&L, a balance sheet, and a cash-flow statement. The benchmark is 10 to 15 business days after month-end. Make them put a number on it. Then ask what happens in months where they miss it.</p>
</div>
</li>
<li class="ql-item">
<div class="ql-num">04</div>
<div>
<p class="ql-q">Who has the authority to move money out of my accounts?</p>
<p class="ql-a">This is the question almost no one asks. It is the question that matters most. The longer a single bookkeeper has unsupervised access, the larger the loss tends to be. Ask what the firm's internal controls look like. Ask whether any single person can both initiate and approve a payment from your accounts. Ask whether they carry crime insurance. If the answer is "trust me," keep looking.</p>
</div>
</li>
<li class="ql-item">
<div class="ql-num">05</div>
<div>
<p class="ql-q">What software do you use, and do I own the data inside it?</p>
<p class="ql-a">If your future bookkeeper uses QuickBooks Online or Xero, you can hold the subscription yourself and grant them access. The data stays yours no matter what happens to them. If they use a proprietary ledger, ask in writing how you would get a fully readable copy of your books on the day the relationship ends. Then read what they send back carefully.</p>
</div>
</li>
<li class="ql-item">
...
<div class="stat">
<div class="stat-num">$141K</div>
<div class="stat-label">Median small-business fraud loss per incident, per the Association of Certified Fraud Examiners. Bookkeeping-related cases include a Memphis ad agency that lost over $1M and a Buffalo dermatology practice that lost $1.8M over seven years. The longer a single bookkeeper has unsupervised access, the larger the loss tends to be.</div>
</div>

## The cautionary tale: what Bench customers wish they had asked

<div class="callout">
<p class="callout-eyebrow">A case study</p>
<p class="callout-title">On December 27, 2024, Bench Accounting sent thousands of small businesses an email that began with the same nine words.</p>
<p><em>"We regret to inform you that as of December 27, 2024, the Bench platform will no longer be accessible."</em></p>
<p>The site was already offline. Tax season was three weeks away. Customers who had prepaid $3,000, $4,500, even $5,535 for the year had no recourse. Two failure modes from that story are still instructive for anyone hiring a firm today.</p>
<p><strong>Data ownership.</strong> Bench ran its own proprietary ledger. When the company shut down, customers were locked out of years of work because the data lived inside a system they did not control. Customers also using QuickBooks Online in parallel were fine. Customers who had trusted Bench's all-in-one promise were not. Question #5 in the list above exists because of this.</p>
<p><strong>Silent decay.</strong> Customers who looked back at their Bench timeline could see the warning signs months in advance. Slower replies. More bookkeeper turnover. Books slipping further behind each close.</p>
</div>
